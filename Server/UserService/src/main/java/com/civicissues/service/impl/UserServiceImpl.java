...
public class UserServiceImpl implements UserService {
	...
	@Override
	public String getEmailByAadhaar(String aadhaar) {
		
		return userRepository.findByAadhaar(aadhaar).map(User::getEmail)                
				.orElseThrow(() -> new RuntimeException("user not found"));
