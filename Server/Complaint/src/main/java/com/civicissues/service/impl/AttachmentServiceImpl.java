...
import com.civicissues.service.StorageService;
...
public class AttachmentServiceImpl implements AttachmentService {
    ...
    public AttachmentResponseDto createAttachment(AttachmentCreateDto dto) {
        var complaint = complaintRepository.findById(dto.getComplaintId())
                .orElseThrow(() -> new ResourceNotFoundException("complaint not found with id " + dto.getComplaintId()));
        ...
        res.setComplaintId(saved.getComplaint().getId());
    ...
    public List<AttachmentResponseDto> getAttachmentsByComplaint(Long complaintId) {
        return attachmentRepository.findByComplaintId(complaintId)
                ...
                .map(a -> {
                    ...
                    dto.setId(a.getId());
                    dto.setComplaintId(a.getComplaint().getId());
    ...
    @Override
    public AttachmentResponseDto uploadAttachment(Long complaintId, MultipartFile file) {
        ...
        dto.setComplaintId(saved.getComplaint().getId());
