...
public class DepartmentController {
    ...
    public ResponseEntity<ApiResponse<DepartmentResponseDto>> update(
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Department updated successfully",
    ...
    public ResponseEntity<ApiResponse<DepartmentResponseDto>> getById(@PathVariable Long id) {
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Department fetched successfully",
    ...
    public ResponseEntity<ApiResponse<Boolean>> exists(@PathVariable Long id) {
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Department existence checked",
